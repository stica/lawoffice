...
export async function generateMetadata({ params }: { params: { locale: string } }) {
  ...
  return {
    ...
    keywords: [
      "nasljedno pravo", "advokat Banja Luka", "nasljedno pravo Banja Luka",
      "testament", "ostavinski postupak", "nasljedni sporovi", "nasledstvo",
      "ostavina", "izrada testamenta", "advokat za nasledno pravo",
      "inheritance law", "advokat Banja Luka nasljedno pravo",
